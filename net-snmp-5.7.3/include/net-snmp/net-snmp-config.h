...
#define NETSNMP_CONFIGURE_OPTIONS " '--disable-perl-cc-checks' '--disable-embedded-perl' '--disable-agent' '--enable-reentrant' '--with-mibdirs=/opt/morion/monitor/mibs' '--with-mibs=all'"

/* default location to look for mibs to load using the above tokens and/or
   those in the MIBS envrionment variable */
#define NETSNMP_DEFAULT_MIBDIRS "/opt/morion/monitor/mibs"
...
#define NETSNMP_DEFAULT_MIBS "all"
